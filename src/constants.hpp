...
//  2^22 to 4,194,304 entries. Assuming each TTEntry is around 24 bytes (8 bytes for
//  hash, 4 for score, 4 for depth, 4 for type, and 4 for move), this would consume approximately
//  100 MB of RAM (4,194,304 * 24 bytes = 100,663,296 bytes).
